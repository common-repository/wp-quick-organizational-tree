...
function wm_get_node_form(){
	...
	<form class="<?php echo $formClass ?>" method="post" action="">
		<img class="close" src="<?php echo plugins_url( 'lib/horizontal-tree/images/close.png', WM_PLUGIN_MAIN_FILE ) ?>" />
		<br />
		<input type="hidden" name="thumbnail_id" value="">
		<input type="hidden" name="tr_parent_id" value="<?php echo $tr_parent_id ?>">
		<input type="text" class="first_name" name="first_name" value="<?php echo $tr_title ?>" placeholder="first name">
		<input type="text" name="tr_link" value="<?php echo $tr_link ?>" placeholder="url">
		<input type="checkbox" <?php checked( $tr_active_link, '1' ) ?> value="1" name="tr_active_link" id="tr_active_link" />
		...
		<input id="wm_thumb_selector" type="button" style="margin-top: 5px;" class="button-secondary" onclick="wm_addImage(this)" value="<?php _e('Add image', 'websitemap') ?>" >
		<input type="submit" class="btn btn-success <?php echo $buttonClass ?>" style="margin-top: 10px;" name="submit" value="<?php _e('Submit', 'websitemap') ?>">
	</form>
	<?php
	exit();
}
...
function wm_enqueue_for_frame(){
	...
	<link rel="stylesheet" type="text/css" href="<?php echo plugins_url( 'lib/horizontal-tree/style.css', WM_PLUGIN_MAIN_FILE ) ?>" />
	<link rel="stylesheet" type="text/css" href="<?php echo plugins_url( 'css/css.css', WM_PLUGIN_MAIN_FILE ) ?>" />
	<script type="text/javascript" src="<?php echo plugins_url( 'lib/horizontal-tree/js/jquery-1.11.1.min.js', WM_PLUGIN_MAIN_FILE ) ?>"></script>
	<script type="text/javascript" src="<?php echo plugins_url( 'lib/horizontal-tree/js/jquery-migrate-1.2.1.min.js', WM_PLUGIN_MAIN_FILE ) ?>"></script>
	<script type="text/javascript" src="<?php echo plugins_url( 'lib/horizontal-tree/js/jquery-ui.js', WM_PLUGIN_MAIN_FILE ) ?>"></script>
	<script type="text/javascript" src="<?php echo plugins_url( 'lib/horizontal-tree/js/jquery-ui.js', WM_PLUGIN_MAIN_FILE ) ?>"></script>
	<script type="text/javascript" src="<?php echo plugins_url( 'lib/horizontal-tree/js/jquery.tree.js', WM_PLUGIN_MAIN_FILE ) ?>"></script>
